...
<div class="card">
  ...
  <div id="wtab-jobs" class="tab-panel active">
    <div class="action-row" style="margin-bottom:16px">
      ...
      <div class="action-row-right">
        <button class="btn btn-primary btn-sm" data-action="create-job">${icon('plus',14)} New Job</button>
      </div>
    </div>
    ...
    <div class="two-col">
      <div>
        <div class="action-row" style="margin-bottom:12px">
          ...
          <button class="btn btn-primary btn-sm" data-action="add-part">${icon('plus',14)} Add Part</button>
        </div>
        <div class="table-wrap">
          <table>
            <thead><tr>
      ...
      <div>
        <div class="action-row" style="margin-bottom:12px">
          ...
          <button class="btn btn-primary btn-sm" data-action="add-supplier">${icon('plus',14)} Add Supplier</button>
        </div>
        <div class="table-wrap">
          <table>
  ...
  <div id="wtab-warranty" class="tab-panel">
    <div class="action-row" style="margin-bottom:16px">
      <div class="action-row-right">
        <button class="btn btn-primary btn-sm" data-action="new-claim">${icon('plus',14)} New Claim</button>
      </div>
    </div>
    <div class="table-wrap">
      <table>
  ...
  <div id="wtab-roster" class="tab-panel">
    <div class="action-row" style="margin-bottom:16px">
      <div class="action-row-right">
        <button class="btn btn-primary btn-sm" data-action="add-workshop-mechanic">${icon('plus',14)} Add Mechanic</button>
      </div>
    </div>
    <div class="table-wrap">
      <table>
